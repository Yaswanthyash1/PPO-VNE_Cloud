...
def run_simulation(num_episodes, config, total_vn_requests_list, embedded_vn_counts_list, revenues_list, costs_list):
    ...
    generate_graphs(embedded_vn_counts_list, total_vn_requests_list, revenues_list, costs_list)
...
def main():
    ...
    run_simulation(num_episodes, config, total_vn_requests_list, embedded_vn_counts_list, revenues_list, costs_list)
